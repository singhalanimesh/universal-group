export const aboutText = {
  p1: "In the Year 1996, Universal Sales (a Unit of Universal group) was promoted as a Partnership Company and started Air-conditioning business as a Regional Franchise for Sales & Service with “Amtrex Hitachi Appliances Limited (At present Hitachi Home & Life Solution India Limited), a multinational Company Engaged only in Air-conditioning business. With time Universal Sales became a top performer of Hitachi as Sales & Service Dealer in Eastern India.",
...
export const aboutTextCard = [
  {
    ...
    value:
      "If you can dream it, you can achieve it. Nurture your aspirations, for they hold the key to your success. Embrace the journey, for each step forward brings you closer to realizing your dreams. Believe in yourself and make your dreams a reality.",
  },
  {
    key: "strength",
...
export const aboutTextCompany = [
  {
    ...
    value:
      "Air-Conditioning, PowerManagement, Fire Engineering, Ventilation, R & D",
  },
  { key: "Universal Sales", value: "Retail Sales & After-sales service" },
  {
